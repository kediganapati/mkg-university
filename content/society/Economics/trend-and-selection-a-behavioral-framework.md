...
## The First Job — General Finance Company

It was Gudi Padwa in March 2007. I went for a job interview. The company was called General Finance Company; the owner’s name was Anand. The entire interview was in Hindi. I got selected on the spot and was told to join the next day.

Until then, in every English interview, whenever I wanted to say “yes,” only “ya” came out of my mouth. So, when Anand Sir asked questions in Hindi and I answered in Hindi, every time I had to agree, “ya” slipped out automatically. I laughed inside.

General Finance was a DSA (Direct Selling Agent) for ICICI Bank car loans. My post: Office Assistant / Salary: ₹3,000 per month. The money was low, but knowledge was my priority, so I took the job.

My work included: preparing files, filling forms, collecting missing documents from customers, calculating eligible loan amounts, interest rates, and EMIs, getting approvals from ICICI Bank, preparing agreements, and obtaining signatures—the entire loan process.

Daily routine: leave home → go to the boss’s house → take his Activa → open the office → finish yesterday’s pending work → boss arrives → gives me the day’s task list on paper → I complete everything.

## The Mystery of Unequal Interest Rates

After one week, while calculating disbursements, I noticed something strange. Some customers were charged 14% interest, while others paid 23%.

I asked a senior why.

Senior: "Just do the work you’re given."

Even the EMI structure looked wrong. If the yearly interest was fixed at 14%, then roughly 86% should be principal and 14% interest every month. But in reality, early EMIs consisted of 86% interest and only 14% principal, and only in the final EMIs did it reverse. It was deliberately front-loaded, so if anyone prepaid, the company recovered the maximum interest first.

The boss himself decided the interest rate for each customer. Same bank, same car, same tenure—yet one customer paid 14%, another paid 23%. I couldn’t understand this injustice.

## The Game of Trend and Selection

There is another mind within me, whose name is Ganesh. Ganesh is very knowledgeable, and he has answers to all my questions. I asked him—
...
Ganesh: "You go to a fast-food stall to eat vada pav; there, samosa, vada pav, bhaji pav, patties, and bhaji are all there. Most people take bhaji pav; you take vada pav because bhaji pav is available for 20 rupees and it is not spicy. Vada pav is for 15 rupees, and it is spicy. Eating vada pav saves you 5 rupees, and you also get the fun of spicy food. To save money and to enjoy the taste, you take vada pav; it does not matter to you what the crowd is taking. What the world buys, you do not care about; you choose vada pav only for fulfilling your need. This is called selection."
...
## Understanding the Trend and Selection Mentality
...
Kiran: "What is the relation of loan interest with trend and selection mentality?"
...
## Kulfi Example: Economic Behaviour in Urgency
...
## Branded Vada Pav Example: Economic Behaviour in Appearance
...
Ganesh: "Yes, unethically, selection can be used to create upheaval in the economy. When a group deliberately favors certain specific things and hires paid social activists to promote that selection, the demand for other goods available in the country decreases. As a result, economic disruption can occur. Some institutions and groups in society may use selective promotion to create economic upheaval and harm particular groups."
...
## Capability and Trust in Loan Strategy
...
## Daitya Mohini — The Steering Wheel of the Economy
...
## GDP — Gross Domestic Product or Gang Decide Price?

Kiran: "I had heard that economists mainly work on GDP. What is GDP?"

Ganesh: "GDP is the total value of all goods produced and all services provided by the citizens of a country. GDP full form says Gross Domestic Product, but behind it, it works like Gang Decide Price. However, no one can calculate an absolutely exact GDP, because some goods are produced but remain unsold in storage, so their value cannot always be properly counted. In the same way, some services are paid for in cash and are never officially recorded. So, when a country reports its GDP, it is essentially giving an estimate, not an exact reality. Sometimes fake GDP figures are also created to manipulate other countries or even the country’s own citizens. A true economist does not rely only on GDP."

## The Real Growth Formula: GDS

Kiran: "Then what does an economist look at the most?"

Ganesh: "A real economy growth is calculated based on GDS. Full form says Gross Domestic Spending. If some citizen is earning in millions and spending in thousands, his contribution in GDS and the nation would be thousands only. And if someone is earning in millions and spending in millions, then his contribution in GDS and the nation would be millions."

Kiran: "What kind of spending?"
...
Ganesh: "Spending is of three types: 1. Spending for one’s own growth 2. Spending to fulfill one’s desires 3. Spending to impress others
...
## The Four Banking and Finance Policies

Kiran: "What kinds of banking and finance policies does an economist create?"

Ganesh: "An economist has to work on eight fundamental policies: 1. Regulation of the funds deposited in the central bank 2. Control over the amount of investment 3. Fair taxation and efficient tax collection 4. Limited and controlled printing of money"

1. Regulation of the funds deposited in the central bank
...
2. Control over the amount of investment

Kiran: "What does control the amount of investment mean?"
...
3. Fair taxation and efficient tax collection
...
Ganesh: "Raw materials cannot be saved for future transactions because they spoil quickly. Therefore, people started using valuable metals and property in exchange; this is called valuable metal currency. With metal currency, goods and services are purchased."
...
## Budget and Wastage: Beyond Reach

Kiran: "I heard people talking about the budget. What exactly is a budget?"

Ganesh: "Right now, you only have 20 rupees in your pocket, and even that you took from your mother just to eat a vada pav. Do you really want to know about the budget?"

Kiran: "I heard words like economist and budget in the news, but I did not understand anything, so I want to know."

Ganesh: "The day you truly understand the budget, the people who make it might start looking like traitors to you, and you may begin dreaming of becoming a revolutionary and opening fire in Parliament. So, for today, just enjoy your vada pav. The day you become capable of paying taxes, I will explain the budget to you."

Kiran: "I heard wastage affect budget, what kind of wastage?"
...
Kiran: "Can I know more about wastage? Food or something?"

Ganesh: "Right now, you have nothing in storage, so wastage is beyond your reach. I will explain it in more detail when you start storing something yourself."
...
I was just a kid when I started learning about economics in 2007, so I did not have enough experience or a deep understanding of the economy at that time. In this story, I wrote only about the selective parts of economics that I personally experienced and observed in real life. Most of the topics discussed here are connected to real-world experiences rather than textbook content designed only to shape or influence students’ thinking and fill their minds with ready-made quotations.
